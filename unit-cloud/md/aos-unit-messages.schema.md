...
- [![Required](https://img.shields.io/badge/Required-blue) Property `AosUnitMessage > data`](#data)
  ...
  - [Property `AosUnitMessage > data > oneOf > AosFinishProvisioningRequest`](#data_oneOf_i18)
    ...
    - [Property `AosUnitMessage > data > oneOf > AosFinishProvisioningRequest > certificates`](#data_oneOf_i18_certificates)
      - [AosUnitMessage > data > oneOf > AosFinishProvisioningRequest > certificates > certificates items](#autogenerated_heading_56)
...
| + [certificates](#data_oneOf_i18_certificates ) | No      | array of string | No         | -          | Certificates      |
...
| Each item of this array must be                          | Description |
| -------------------------------------------------------- | ----------- |
| [certificates items](#data_oneOf_i18_certificates_items) | -           |

##### <a name="autogenerated_heading_56"></a>AosUnitMessage > data > oneOf > AosFinishProvisioningRequest > certificates > certificates items
